...
class Plugin_Core extends Loader{
	...
	//	var_dump(SCSCORE_PLUGINDIR);
		self::$current_plugin_data = get_file_data(SCSCORE_PLUGINDIR.'/scscore.php', self::$default_headers);
		$this->classloader();
	}
	/* ----- magic methods --------------------------------- */
	/**
...
/* Log any errors */ 
	public function logger($data){
		$f = @fopen(SCSCORE_PLUGINDIR.'/_errorlog.txt', 'a+');
