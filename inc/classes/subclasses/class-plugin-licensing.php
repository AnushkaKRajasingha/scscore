...
class Plugin_lisense extends Plugin_Core{
	...
	public function _activation_page(){
		...
		if(file_exists(SCSCORE_PLUGIN_PAGES.'/css/'.$page_stylefile))
			wp_enqueue_style( self::$current_plugin_data['TextDomain'].'-licensing-style',SCSCORE_PLUGIN_CSSDIR_URL.'/'.$page_stylefile,array(),self::$current_plugin_data['Version']);
		$page_scriptfile = 'script_licensing.js';
		if(file_exists(SCSCORE_PLUGIN_PAGES.'/js/'.$page_scriptfile))
			wp_enqueue_script( self::$current_plugin_data['TextDomain'].'-licensing-script',SCSCORE_PLUGIN_JSDIR_URL.'/'.$page_scriptfile,array('jquery','common-data','bootbox.min','plugin_utilities'),self::$current_plugin_data['Version'],true);
		
		include_once SCSCORE_PLUGIN_PAGES.'/page_licensing.php';
	}
	...
	public function _expire_page(){
		...
		if(file_exists(SCSCORE_PLUGIN_PAGES.'/css/'.$page_stylefile))
			wp_enqueue_style( self::$current_plugin_data['TextDomain'].'-expired-style',SCSCORE_PLUGIN_CSSDIR_URL.'/'.$page_stylefile,array(),self::$current_plugin_data['Version']);
		$page_scriptfile = 'script_expired.js';
		if(file_exists(SCSCORE_PLUGIN_PAGES.'/js/'.$page_scriptfile))
			wp_enqueue_script( self::$current_plugin_data['TextDomain'].'-expired-script',SCSCORE_PLUGIN_JSDIR_URL.'/'.$page_scriptfile,array('jquery','common-data','bootbox.min','plugin_utilities'),self::$current_plugin_data['Version'],true);
	
		include_once SCSCORE_PLUGIN_PAGES.'/page_expired.php';
	}
