...
<div class="modal fade" data-backdrop="static" data-keyboard="false" id="pw_modal<?php echo page_key();?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                               ...
                               <div style="width:100%;text-align: center;">
                                <img width="100px"  src="<?php echo SCSCORE_PLUGIN_IMGDIR_URL;?>/gears2.gif" /></div>                                        
                                 </div>
                                    </div>
                                </div>
                            </div>
...
<div class="wrap redux-container">
	...
	<div class="wrapper">
		...
		<!-- <header class="panel-heading page-title"><h2><?php echo page_title(); ?><div id="load_bar_ctrl" class="pull-right"><img alt="Loading..." src="<?php echo SCSCORE_PLUGIN_IMGDIR_URL;?>/loading_bar.gif"></div></h2></header> -->